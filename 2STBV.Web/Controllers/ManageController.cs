...
using _2STBV.Web.Models;
using _2STBV.Web.Helpers;
using System.Configuration;

namespace _2STBV.Web.Controllers
{
    [Authorize]
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> EnableTwoFactorAuthentication()
        {
            ...
            return RedirectToAction("VerifyTelegramAccount", new { UserId = user.Id });
        }
        ...
        //
        // POST: /Manage/VerifyTelegramAccount
        [HttpPost]
        [ValidateAntiForgeryToken]
